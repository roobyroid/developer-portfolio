	...
	return (
		...
		>
			...
			<FramerImage
				...
				src={img}
				alt={title}
				className="z-20 w-96 h-auto hidden absolute rounded-lg object-contain md:!hidden max-h-[200px]"
...
const Article = ({ img, title, date, link }) => {
	return (
		...
		bg-light text-dark border border-solid border-dark first:mt-0 border-r-4 border-b-4 dark:border-light dark:bg-dark dark:text-light
		sm:flex-col"
		>
			<MovingImg title={title} img={img} link={link} />
			<span className="text-primary font-semibold pl-4 dark:text-primaryDark sm:self-start sm:pl-0 sm:mt-2 xs:text-sm">
				{date}
			</span>
		</motion.li>
	);
